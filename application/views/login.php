...
<head>
    <title>WEB-PT.PPA | MENPROS</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--===============================================================================================-->
    <link rel="shortcut icon" href="<?= base_url() ?>assets/login/images/pt.ppa.png">
...
<style>
    ...
    .custom-bg{
        background-image: url("assets/login/images/111.jpeg");
        ...
        <div class="container-login100 custom-bg">
            <div class="wrap-login100 box">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="<?= base_url();?>assets/login/images/pt.ppa.png" alt="IMG">
                </div>

                <form class="login100-form validate-form" action="<?= base_url();?>Auth/login_processed" method="POST">
                    <?= $this->session->flashdata('message'); ?>
                    <span class="login100-form-title">
                        Sistem Informasi Manajemen Proposal PT.Putra Perkasa Abadi
                    </span>
					
                   <div class="wrap-input100 validate-input" data-validate="NRP">
                        <input class="input100" type="text" name="NRP" placeholder="NRP" autocomplete="off">
                    ...
                    <div class="container-login100-form-btn">
                        <button class="login100-form-btn" style="background: #f12828;">
                            Login
                        </button>
                    </div>
                </form>
