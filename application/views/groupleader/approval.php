                                    ...
                                    <table id="example2" class="table table-bordered table-striped">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $alasan ?></td>
                                                <td class="btnlist">
                                                    <a href="<?php echo base_url('Approval/setujuLevel1/') . $id_permohonan ?>" class="btn btn-info" data-toggle="modal" data-target="#Disetujui<?= $id_permohonan ?>"><i class="nav-icon fas fa-check" title="Setuju"></i>
                                                    </a>
                                                ...
                                                <div class="modal-dialog hapusmdl">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="<?php echo base_url()?>Approval/acc_laporan_gl/2"
                                            ...
                                            <div class="modal fade" id="Ditolak<?= $id_permohonan ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="<?php echo base_url()?>Approval/acc_laporan_gl/3"
                                                                method="post" enctype="multipart/form-data">
                                                                <div class="row">
                                                                    <div class="col-md-12">
